...
class PoseEstimator:
    ...
    def __init__(self, img_size=(480, 640)):
        ...
        #Getting my camera internals @gs
        self.camera_matrix = np.array(
            [[725.7657025001567, 0.0, 302.64698191622074],
        [0.0, 733.3294790963405, 277.5564048217287],
        [0.0, 0.0, 1.0] 
        ], dtype="double")
        
        # Assuming no lens distortion
        self.dist_coeefs = np.array([[0.35136313880105813, -3.2814702001594096, -0.002180299088962941, 0.00383256440875228, 12.160646308561365 ]])
